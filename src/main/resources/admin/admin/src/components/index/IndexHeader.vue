<template>
  ...
  <div :style="{backgroundColor:heads.headBgColor,height:heads.headHeight,boxShadow:heads.headBoxShadow,lineHeight:heads.headHeight}"
       class="navbar">
  ...
  data() {
    return {
      ...
      heads: {
        ...
        "headFontSize": "25px",
        "headUserInfoFontColor": "rgba(231, 231, 231, 1)",
        "headBoxShadow": "0px 0px 0px 10px #FFFF66",
        "headTitleImgHeight": "44px",
        "headLogoutFontHoverBgColor": "rgba(170, 153, 153, 0.41)",
        ...
        "headLogoutFontColor": "rgba(231, 231, 231, 1)",
