<template>
  <el-aside class="index-aside" height="100vh" width="230px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" v-if="role==item.roleName" :key="item.roleName" class="menulist-item"
           style="height:100%;broder:0;background-color:#FCFCFC">
        <div v-if="false && menulistStyle == 'vertical'" class="menulistImg"
             style="backgroundColor:#ff0000;padding:25px 0">
          <el-image v-if="'http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg'"
                    fit="cover" src="http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg"/>
        </div>
        <el-menu :unique-opened="true" active-text-color="#000000" background-color="#FCFCFC" class="el-menu-demo"
                 default-active="0" mode="vertical" style="height:100%;" text-color="#19A97B">
          <el-menu-item :style="menulistBorderBottom" index="0" @click="menuHandler('')"><i v-if="true"
