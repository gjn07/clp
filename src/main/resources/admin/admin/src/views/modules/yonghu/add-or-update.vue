<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="账号" prop="zhanghao">
            <el-input v-model="ruleForm.zhanghao"
                      :readonly="ro.zhanghao" clearable placeholder="账号"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="姓名" prop="xingming">
            <el-input v-model="ruleForm.xingming"
                      :readonly="ro.xingming" clearable placeholder="姓名"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="邮箱" prop="youxiang">
            <el-input v-model="ruleForm.youxiang"
                      :readonly="ro.youxiang" clearable placeholder="邮箱"></el-input>
          </el-form-item>
          <div v-else>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item v-if="type!='info'" class="textarea" label="备注" prop="beizhu">
            <el-input
