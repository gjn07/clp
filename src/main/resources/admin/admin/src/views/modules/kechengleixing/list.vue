  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '课程类型' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" v-model="searchForm.kechengleixing"
                      clearable placeholder="课程类型" prefix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" v-model="searchForm.kechengleixing"
                      clearable placeholder="课程类型" suffix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.kechengleixing" clearable
      ...
      <div class="table-content">
        <el-table v-if="isAuth('kechengleixing','查看')" v-loading="dataListLoading" :border="contents.tableBorder"
          ...
          <el-table-column :align="contents.tableAlign" header-align="center"
            ...
            <template slot-scope="scope">
              <el-button
                  v-if="isAuth('kechengleixing','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-edit" size="mini" type="primary" @click="addOrUpdateHandler(scope.row.id)">{{
                contents.tableBtnFont == 1?'修改':'' }}
              </el-button>
              <el-button
                  v-if="isAuth('kechengleixing','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('kechengleixing','修改') && contents.tableBtnIcon == 0" size="mini" type="primary"
                         @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'修改':'' }}
              </el-button>


              <el-button
                  v-if="isAuth('kechengleixing','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-delete" size="mini" type="danger" @click="deleteHandler(scope.row.id)">{{
                contents.tableBtnFont == 1?'删除':'' }}
              </el-button>
              <el-button
                  v-if="isAuth('kechengleixing','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('kechengleixing','删除') && contents.tableBtnIcon == 0" size="mini" type="danger"
