<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="商品表名" prop="tablename">
            <el-input v-model="ruleForm.tablename"
                      :readonly="ro.tablename" clearable placeholder="商品表名"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="商品id" prop="goodid">
            <el-input v-model="ruleForm.goodid"
                      :readonly="ro.goodid" clearable placeholder="商品id"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="24">
          <el-form-item v-if="type!='info' && !ro.picture" class="upload" label="图片" prop="picture">
            <file-upload
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="单价" prop="price">
            <el-input v-model="ruleForm.price"
                      :readonly="ro.price" clearable placeholder="单价"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="会员价" prop="discountprice">
            <el-input v-model="ruleForm.discountprice"
                      :readonly="ro.discountprice" clearable placeholder="会员价"></el-input>
          </el-form-item>
          <div v-else>
