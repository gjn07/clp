  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
        ...
        <el-row :gutter="20" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '名称' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" v-model="searchForm.name"
                      clearable placeholder="名称" prefix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" v-model="searchForm.name"
                      clearable placeholder="名称" suffix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.name" clearable placeholder="名称"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <div class="table-content">
        <el-table v-if="isAuth('config','查看')" v-loading="dataListLoading" :border="contents.tableBorder"
          ...
          <el-table-column :align="contents.tableAlign" :sortable="contents.tableSortable" header-align="center"
            ...
            <template slot-scope="scope">
              <div v-if="scope.row.value">
                <img :src="scope.row.value.split(',')[0]" height="100" width="100">
              </div>
              <div v-else>无图片</div>
            </template>
          </el-table-column>
          <el-table-column :align="contents.tableAlign" header-align="center"
            ...
            <template slot-scope="scope">
              ...
              <el-button v-if="isAuth('config','查看') && contents.tableBtnIcon == 0" size="mini" type="success"
              ...
              <el-button v-if="isAuth('config','修改') && contents.tableBtnIcon == 0" size="mini" type="primary"
              ...
              <el-button v-if="isAuth('config','删除') && contents.tableBtnIcon == 0" size="mini" type="danger"
