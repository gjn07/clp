  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      ...
      <div class="table-content">
        <el-table v-if="isAuth('address','查看')" v-loading="dataListLoading" :border="contents.tableBorder"
          ...
          <el-table-column :align="contents.tableAlign" header-align="center"
            ...
            <template slot-scope="scope">
              ...
              <el-button v-if="isAuth('address','查看') && contents.tableBtnIcon == 0" size="mini" type="success"
              ...
              <el-button v-if="isAuth('address','修改') && contents.tableBtnIcon == 0" size="mini" type="primary"
              ...
              <el-button v-if="isAuth('address','删除') && contents.tableBtnIcon == 0" size="mini" type="danger"
