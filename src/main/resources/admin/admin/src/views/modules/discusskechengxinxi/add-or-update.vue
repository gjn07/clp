<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item v-if="type!='info'" class="textarea" label="评论内容" prop="content">
            <el-input
                v-model="ruleForm.content"
                :rows="8"
                placeholder="评论内容"
                readonly
                style="min-width: 200px; max-width: 600px;" type="textarea">
            </el-input>
          </el-form-item>
          <div v-else>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item v-if="type!='info'" class="textarea" label="回复内容" prop="reply">
            <el-input
