<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="课程编号" prop="kechengbianhao">
            <el-input v-model="ruleForm.kechengbianhao"
                      placeholder="课程编号" readonly></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.kechengbianhao" class="input" label="课程编号" prop="kechengbianhao">
              <el-input v-model="ruleForm.kechengbianhao"
                        placeholder="课程编号" readonly></el-input>
            </el-form-item>
          </div>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="课程名称" prop="kechengmingcheng">
            <el-input v-model="ruleForm.kechengmingcheng"
                      :readonly="ro.kechengmingcheng" clearable placeholder="课程名称"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="select" label="课程类型" prop="kechengleixing">
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="关键字" prop="guanjianzi">
            <el-input v-model="ruleForm.guanjianzi"
                      :readonly="ro.guanjianzi" clearable placeholder="关键字"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="关键字" prop="guanjianzi">
              <el-input v-model="ruleForm.guanjianzi"
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="课时" prop="keshi">
            <el-input v-model="ruleForm.keshi"
                      :readonly="ro.keshi" clearable placeholder="课时"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="24">
          <el-form-item v-if="type!='info'" class="upload" label="课程视频" prop="kechengshipin">
            <file-upload
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.kechengshipin" label="课程视频" prop="kechengshipin">
              <el-button size="small" type="text" @click="download(ruleForm.kechengshipin)">预览</el-button>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="24">
          <el-form-item v-if="type!='info' && !ro.fengmian" class="upload" label="封面" prop="fengmian">
            <file-upload
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.fengmian" label="封面" prop="fengmian">
              <img v-for="(item,index) in ruleForm.fengmian.split(',')" v-bind:key="index" :src="item"
                   height="100" style="margin-right:20px;" width="100">
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="教师工号" prop="jiaoshigonghao">
            <el-input v-model="ruleForm.jiaoshigonghao"
                      :readonly="ro.jiaoshigonghao" clearable placeholder="教师工号"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="教师姓名" prop="jiaoshixingming">
            <el-input v-model="ruleForm.jiaoshixingming"
                      :readonly="ro.jiaoshixingming" clearable placeholder="教师姓名"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="价格" prop="price">
            <el-input v-model="ruleForm.price"
                      :readonly="ro.price" clearable placeholder="价格"></el-input>
          </el-form-item>
          <div v-else>
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item v-if="type!='info'" class="textarea" label="课程详情" prop="kechengxiangqing">
            <el-input
  ...
  data() {
    ...
    return {
      addEditForm: {
        ...
        "selectFontSize": "14px",
        "btnCancelBorderColor": "rgba(255, 255, 102, 1)",
        "inputBorderRadius": "4px",
        "inputFontSize": "14px",
        "textareaBgColor": "rgba(255, 255, 255, 0.25)",
        ...
        "inputLableColor": "rgba(25, 169, 123, 1)",
        "addEditBoxColor": "rgba(25, 169, 123, 0.11)",
        "dateIconFontSize": "14px",
        "btnSaveBgColor": "rgba(25, 169, 123, 1)",
        "uploadIconFontColor": "rgba(25, 169, 123, 1)",
        "textareaBorderColor": "rgba(25, 169, 123, 1)",
        "btnCancelBgColor": "rgba(255, 255, 102, 1)",
        "selectLableColor": "rgba(25, 169, 123, 1)",
        ...
        "uploadHeight": "148px",
        "textareaLableColor": "rgba(25, 169, 123, 1)",
        ...
        "uploadLableColor": "rgba(25, 169, 123, 1)",
        ...
        "dateHeight": "40px",
        "selectBorderColor": "rgba(25, 169, 123, 1)",
        "inputBorderColor": "rgba(25, 169, 123, 1)",
        "uploadBorderColor": "rgba(25, 169, 123, 1)",
        "textareaFontColor": "rgba(0, 0, 0, 1)",
        ...
        "selectFontColor": "rgba(25, 169, 123, 1)",
        "btnSaveBorderColor": "rgba(25, 169, 123, 1)",
