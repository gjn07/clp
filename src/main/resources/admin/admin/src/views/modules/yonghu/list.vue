  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '姓名' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" v-model="searchForm.xingming"
                      clearable placeholder="姓名" prefix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" v-model="searchForm.xingming"
                      clearable placeholder="姓名" suffix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.xingming" clearable
                      placeholder="姓名"></el-input>
          </el-form-item>
          <el-form-item :label="contents.inputTitle == 1 ? '性别' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" v-model="searchForm.xingbie"
                      clearable placeholder="性别" prefix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" v-model="searchForm.xingbie"
                      clearable placeholder="性别" suffix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.xingbie" clearable
      ...
      <div class="table-content">
        <el-table v-if="isAuth('yonghu','查看')" v-loading="dataListLoading" :border="contents.tableBorder"
          ...
          <el-table-column :align="contents.tableAlign" header-align="center"
            ...
            <template slot-scope="scope">
              ...
              <el-button v-if="isAuth('yonghu','查看') && contents.tableBtnIcon == 0" size="mini" type="success"
              ...
              <el-button v-if="isAuth('yonghu','修改') && contents.tableBtnIcon == 0" size="mini" type="primary"
              ...
              <el-button v-if="isAuth('yonghu','删除') && contents.tableBtnIcon == 0" size="mini" type="danger"
