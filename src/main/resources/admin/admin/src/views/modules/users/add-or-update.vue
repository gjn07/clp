<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="用户名" prop="username">
            <el-input v-model="ruleForm.username"
                      :readonly="ro.username" clearable placeholder="用户名"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="密码" prop="password">
            <el-input v-model="ruleForm.password"
                      :readonly="ro.password" clearable placeholder="密码"></el-input>
          </el-form-item>
          <div v-else>
