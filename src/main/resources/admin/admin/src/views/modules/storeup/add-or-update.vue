<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="收藏id" prop="refid">
            <el-input v-model="ruleForm.refid"
                      :readonly="ro.refid" clearable placeholder="收藏id"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="表名" prop="tablename">
            <el-input v-model="ruleForm.tablename"
                      :readonly="ro.tablename" clearable placeholder="表名"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="收藏名称" prop="name">
            <el-input v-model="ruleForm.name"
                      :readonly="ro.name" clearable placeholder="收藏名称"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="24">
          <el-form-item v-if="type!='info' && !ro.picture" class="upload" label="收藏图片" prop="picture">
            <file-upload
