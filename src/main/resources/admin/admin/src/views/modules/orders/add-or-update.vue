<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="订单编号" prop="orderid">
            <el-input v-model="ruleForm.orderid"
                      placeholder="订单编号" readonly></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.orderid" class="input" label="订单编号" prop="orderid">
              <el-input v-model="ruleForm.orderid"
                        placeholder="订单编号" readonly></el-input>
            </el-form-item>
          </div>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="商品名称" prop="goodname">
            <el-input v-model="ruleForm.goodname"
                      :readonly="ro.goodname" clearable placeholder="商品名称"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="24">
          <el-form-item v-if="type!='info' && !ro.picture" class="upload" label="商品图片" prop="picture">
            <file-upload
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.picture" label="商品图片" prop="picture">
              <img v-for="(item,index) in ruleForm.picture.split(',')" v-bind:key="index" :src="item"
                   height="100" style="margin-right:20px;" width="100">
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="购买数量" prop="buynumber">
            <el-input v-model="ruleForm.buynumber"
                      :readonly="ro.buynumber" clearable placeholder="购买数量"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="价格/积分" prop="price">
            <el-input v-model="ruleForm.price"
                      :readonly="ro.price" clearable placeholder="价格/积分"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="折扣价格" prop="discountprice">
            <el-input v-model="ruleForm.discountprice"
                      :readonly="ro.discountprice" clearable placeholder="折扣价格"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="总价格/总积分" prop="total">
            <el-input v-model="ruleForm.total"
                      :readonly="ro.total" clearable placeholder="总价格/总积分"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="折扣总价格" prop="discounttotal">
            <el-input v-model="ruleForm.discounttotal"
                      :readonly="ro.discounttotal" clearable placeholder="折扣总价格"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="select" label="支付类型" prop="type">
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="select" label="状态" prop="status">
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="地址" prop="address">
            <el-input v-model="ruleForm.address"
                      :readonly="ro.address" clearable placeholder="地址"></el-input>
          </el-form-item>
          <div v-else>
