<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="名称" prop="name">
            <el-input v-model="ruleForm.name"
                      :readonly="ro.name" clearable placeholder="名称"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="24">
          <el-form-item v-if="type!='info' && !ro.value" class="upload" label="值" prop="value">
            <file-upload
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.value" label="值" prop="value">
              <img v-for="(item,index) in ruleForm.value.split(',')" v-bind:key="index" :src="item"
