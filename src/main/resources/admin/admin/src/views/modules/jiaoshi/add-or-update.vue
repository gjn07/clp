  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="密码" prop="mima">
            <el-input v-model="ruleForm.mima"
                      :readonly="ro.mima" clearable placeholder="密码"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="select" label="性别" prop="xingbie">
        ...
        <el-col :span="24">
          <el-form-item v-if="type!='info' && !ro.zhaopian" class="upload" label="照片" prop="zhaopian">
            <file-upload
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.zhaopian" label="照片" prop="zhaopian">
              <img v-for="(item,index) in ruleForm.zhaopian.split(',')" v-bind:key="index" :src="item"
                   height="100" style="margin-right:20px;" width="100">
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="职称" prop="zhicheng">
            <el-input v-model="ruleForm.zhicheng"
                      :readonly="ro.zhicheng" clearable placeholder="职称"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="联系电话" prop="lianxidianhua">
            <el-input v-model="ruleForm.lianxidianhua"
                      :readonly="ro.lianxidianhua" clearable placeholder="联系电话"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="教师邮箱" prop="jiaoshiyouxiang">
            <el-input v-model="ruleForm.jiaoshiyouxiang"
                      :readonly="ro.jiaoshiyouxiang" clearable placeholder="教师邮箱"></el-input>
          </el-form-item>
          <div v-else>
