  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">社区学习平台注册</h1>
        <el-form ref="rgsForm" :model="rgsForm" class="rgs-form" label-width="120px">
          ...
          <el-form-item v-if="tableName=='yonghu'" class="input" label="账号">
          ...
          <el-form-item v-if="tableName=='yonghu'" class="input" label="密码">
          ...
          <el-form-item v-if="tableName=='yonghu'" class="input" label="姓名">
          ...
          <el-form-item v-if="tableName=='yonghu'" class="input" label="手机">
          ...
          <el-form-item v-if="tableName=='yonghu'" class="input" label="邮箱">
          ...
          <el-form-item v-if="tableName=='jiaoshi'" class="input" label="教师工号">
          ...
          <el-form-item v-if="tableName=='jiaoshi'" class="input" label="密码">
            <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text"/>
          </el-form-item>
          <!-- <div v-if="tableName=='jiaoshi'" class="input-group">
          ...
          <el-form-item v-if="tableName=='jiaoshi'" class="input" label="教师姓名">
          ...
          <el-form-item v-if="tableName=='jiaoshi'" class="input" label="职称">
          ...
          <el-form-item v-if="tableName=='jiaoshi'" class="input" label="联系电话">
          ...
          <el-form-item v-if="tableName=='jiaoshi'" class="input" label="教师邮箱">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if (`jiaoshi` == this.tableName && this.ruleForm.money && (!this.$validate.isNumber(this.ruleForm.money))) {
        this.$message.error(`余额应输入数字`);
        return
      }
      this.$http({
